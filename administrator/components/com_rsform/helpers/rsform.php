        ...
        switch ($r['ComponentTypeName']) {
            case 'textBox': {
                    ...
                    $out .= '<td>' . $data['CAPTION'] . '</td>' .
                            '<td>' . $codeIcon . '<input type="text" class="form-control" value="' . RSFormProHelper::htmlEscape($defaultValue) . '" size="' . $data['SIZE'] . '" /></td>';
                }
                break;
            ...
            case 'textArea': {
                    ...
                    $out .= '<td>' . $data['CAPTION'] . '</td>' .
                            '<td>' . $codeIcon . '<textarea class="form-control" cols="' . $data['COLS'] . '" rows="' . $data['ROWS'] . '">' . RSFormProHelper::htmlEscape($defaultValue) . '</textarea></td>';
                }
                break;
            ...
            case 'selectList': {
                    ...
                    $out .= '<td>' . $codeIcon . '<select class="form-control" ' . ($data['MULTIPLE'] == 'YES' ? 'multiple="multiple"' : '') . ' size="' . $data['SIZE'] . '">';
            ...
            case 'checkboxGroup': {
                    ...
                    foreach ($items as $item) {
                        ...
                        $out.='<input class="form-control" type="checkbox" ' . $additional . ' value="' . RSFormProHelper::htmlEscape($val) . '" id="' . $data['NAME'] . $i . '"/><label for="' . $data['NAME'] . $i . '">' . $txt . '</label>';
            ...
            case 'radioGroup': {
                    ...
                    foreach ($items as $item) {
                        ...
                        $out.='<input class="form-control" type="radio" ' . $additional . ' value="' . RSFormProHelper::htmlEscape($val) . '" id="' . $data['NAME'] . $i . '"/><label for="' . $data['NAME'] . $i . '">' . $txt . '</label>';
                        if ($data['FLOW'] == 'VERTICAL')
                            $out.='<br/>';
                        $i++;
                    }
            ...
            case 'captcha': {
                    ...
                    switch (@$data['IMAGETYPE']) {
                        ...
                        case 'NOFREETYPE':
                            ...
                            $out.='<input class="form-control" type="text" value="" id="captchaTxt' . $componentId . '" ' . $data['ADDITIONALATTRIBUTES'] . ' />';
            ...
            case 'submitButton': {
                    ...
                    if (isset($data['BUTTONTYPE']) && $data['BUTTONTYPE'] == 'TYPEBUTTON')
                        $out.='<td><button type="button" class="btn btn-lg btn-primary">' . RSFormProHelper::htmlEscape($data['LABEL']) . '</button>';
                    else
                        $out.='<td><input type="button" class="btn btn-lg btn-primary" value="' . RSFormProHelper::htmlEscape($data['LABEL']) . '" />';
